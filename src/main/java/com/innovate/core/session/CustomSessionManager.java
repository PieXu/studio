...
import com.innovate.core.session.model.UserOnlineBo;
 ...
 * 用户Session 手动管理
 * @author IvanHsu
 * @2018年3月23日 下午1:48:43
 */
public class CustomSessionManager {

	public static final String SESSION_STATUS ="itms-online-status";
	...
	public List<SimplePrincipalCollection> getSimplePrincipalCollectionByUserId(Long...userIds){
		//把userIds 转成Set，好判断
		Set<Long> idset = (Set<Long>) CommonUtils.array2Set(userIds);
		//获取所有session
		Collection<Session> sessions = customShiroSessionDAO.getActiveSessions();
		//定义返回
