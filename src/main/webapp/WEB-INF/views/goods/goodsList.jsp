...
<%@ taglib uri="http://com.innovate.page.tld" prefix="page"%>
	<div class="Hui-article">
		<article class="cl pd-20">
			<form action="goods/listGoods.do" method="post" id="goods_list_form" >
				...
				<%-- 	<span style="padding-left:15px">
						类型：<input type="text" name="type" id="type"  value="${goods.type }"  placeholder=" 轴承类型" style="width:150px" class="input-text radius">
					</span> --%>
					<span style="padding-left:10px">
						<button class="btn btn-primary radius" type="submit">查 询</button>
						<button class="btn btn-success radius" type="button" onclick="clearSerachForm('goods_list_form')">清 空</button>
					</span>
				</div>
			</form>
			<div class="mt-30">
